...
var Game = React.createClass({
    ...
    render: function() {
        ...
        //console.log("RENDER",battle.get("layers").toJS(),"marks",battle.get("marks").toJS(),"data",battle.get("data").toJS(),battle.get("forbidden"))//,"context",battle.get("context").toJS(),battle.getIn(["data","units"]).toJS(),battle.get("save").toJS(),battle.get("path").toJS(),"CONNECTIONS",battle.get("connections").toJS());
        return (
            <div>
